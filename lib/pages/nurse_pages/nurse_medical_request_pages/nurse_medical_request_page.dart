...
class NurseMedicalRequestPage extends StatefulWidget {
  const NurseMedicalRequestPage({Key? key}) : super(key: key);

  @override
  State<NurseMedicalRequestPage> createState() =>
      _NurseMedicalRequestPageState();
}

class _NurseMedicalRequestPageState
    extends State<NurseMedicalRequestPage> {
  @override
  Widget build(BuildContext context) {
    return GetBuilder<NurseMedicalRequestController>(
        init: NurseMedicalRequestController(),
        builder: (controller) {
          return Scaffold(
                              ...
                              children: [
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    label.keys.elementAt(0)!="Description"?Divider(color: Colors.black,):Divider(color: Colors.blue,),
                                  ],
                                ),
                              ),
                              )
