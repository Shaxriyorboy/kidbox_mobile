...
import 'parent_device_controller.dart';

class ParentCurrentSession extends StatelessWidget {
  ParentDeviceController controller;
   ParentCurrentSession({Key? key,required this.controller}) : super(key: key);
    ...
    return  Container(
      ...
      child: Column(
        ...
        children: [
          ...
          InkWell(
            onTap: (){
              showAlertDialog(context: context, title: "End other sessions", body: "Do you want end other session", confirm: controller.onDelete); 
            },
            child: SizedBox(
                height: 63.h,
                width: 1.sw,
...
class ParentActiveSession extends StatelessWidget {
  const ParentActiveSession({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Container(
