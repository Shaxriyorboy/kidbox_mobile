...
class DirectorAddNoticeController extends GetxController {
  final bodyController = TextEditingController();
  final titleController = TextEditingController();
  String body = "A holiday event dedicated to the language holiday";
              ...
              child: Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () async{
                      Get.back();
                      Utils.getPickedImages().then((image){
                        if(image!=null) imageFileList.addAll(image);
                        update();
                      });
                    },
                    child: Column(
  ...
  Future showBottomSheet(BuildContext context) {
    return showModalBottomSheet(
      ...
      builder: (context) => GetBuilder<DirectorAddNoticeController>(
          builder: (context) {
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return CheckboxListTile(
                                  ...
                                  title: Text("Saydullayev E.V", style: TextStyle(fontSize: 20.sp, fontWeight: FontWeight.w500,),
                                  ),
