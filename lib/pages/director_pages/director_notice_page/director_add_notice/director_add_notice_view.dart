...
import 'director_add_notice_controller.dart';
      /// #CreatNotice
      Widget createNotice(DirectorAddNoticeController ctrl,BuildContext context) {
  return Container(
    ...
    children: [
      ElevatedButton.icon(
        ...
        label: Text("notice".tr, style: TextStyle(fontSize: 20.sp,
      ...
      ElevatedButton(
        ...
        onPressed: () {},
        child: Text("save".tr, style: TextStyle(fontSize: 18.sp,
            fontWeight: FontWeight.w600,
            color: Colors.black),),
      ),
    ],
      ...
      /// #ChoseClass
      Widget choseClass(DirectorAddNoticeController ctrl,BuildContext context){
        return Container(
          decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(15.r),
              color: Colors.white
            ...
            child: ExpansionTile(
              ...
              children: [1,2,3].map((e) => Column(
                children: [
                 ...
                 ListTile(
                   onTap: () => ctrl.showBottomSheet(context),
