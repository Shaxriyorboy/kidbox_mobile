...
class DiredtorCurrentSession extends StatelessWidget {
  DirectorDeviceController controller;
   DiredtorCurrentSession({Key? key,required this.controller}) : super(key: key);
...
class DiredtorActiveSession extends StatelessWidget {
  const DiredtorActiveSession({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Container(
