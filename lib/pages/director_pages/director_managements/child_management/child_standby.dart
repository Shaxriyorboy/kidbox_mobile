...
class ChildStandby extends StatefulWidget {
  ChildStandby({Key? key}) : super(key: key);

  @override
  State<ChildStandby> createState() => _ChildStandbyState();
}

class _ChildStandbyState extends State<ChildStandby> {
  @override
  Widget build(BuildContext context) {
    return GetBuilder<DirChildManageController>(builder: (controller) {
      return Container(
  ...
  void showGroupBottomSheet(BuildContext context) {
    showModalBottomSheet(
        ...
        context: context,
        builder: (context) {
          return GetBuilder<DirChildManageController>(
            builder: (controller) {
              return WillPopScope(
                onWillPop: () async {
